...
<div class="content-wrapper">
	...
	<section class="content container-fluid">
		...
		<!--------------------------
			...
			<?= form_open('notifikasi/add',array("class"=>"form-horizontal")); ?>
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<input type="text" name="frekuensi" value="<?= $this->input->post('frekuensi'); ?>" class="form-control" id="frekuensi" /> hari
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<input type="text" name="kode" value="<?= $this->input->post('kode'); ?>" class="form-control" id="kode" />
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<input type="text" name="judul" value="<?= $this->input->post('judul'); ?>" class="form-control" id="judul" />
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<input type="text" name="jenis" value="<?= $this->input->post('jenis'); ?>" class="form-control" id="jenis" />
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<input type="text" name="server" value="<?= $this->input->post('server'); ?>" class="form-control" id="server" />
				...
				<div class="form-group">
					...
					<div class="col-md-8">
						<textarea name="isi" class="form-control" id="isi"><?= $this->input->post('isi'); ?></textarea>
