...
@section('content')
    ...
    <div class="row">
    <h1>Versi LayananDesa<small class="font-weight-light ml-1 text-md font-weight-bold">(Versi yang terpasang di desa)</small></h1>
        <div class="col-lg-12">
        ...
        var layananVersi = $('#table-versi').DataTable({
            ...
            columns: [{
                ...
                },                
                {
                    name: 'jumlah',
                    data: function (data) {
                        return `<a target="_blank" href="{{ url('web/layanandesa/versi/detail') }}?versi=${data.versi}">${data.jumlah}</a>`
                    },
                    searchable: false,
                },                
            ]
