...
@section('title', 'LayananDesa')

@section('content')        
    <div class="row">
    <h1>
        LayananDesa<small class="font-weight-light ml-1 text-md font-weight-bold">(Desa yang memasang LayananDesa)
        </small></h1>
        <div class="col-lg-12">
            <div class="card card-outline card-primary">
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table class="table" id="table-layanandesa">
                            <thead>
                                <tr>
                                    <th>No</th>                                    
                                    <th>Desa</th>
...
@section('js')
    <script>
        ...
        var desa = $('#table-layanandesa').DataTable({
                processing: true,
                serverSide: true,
                autoWidth: false,
                ordering: true,
                ...
                ajax: {
                    url: `{{ url('web/layanandesa/versi/detail') }}`,
                    method: 'get',
                    data: function(data) {
