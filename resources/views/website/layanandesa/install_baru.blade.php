    ...
    <script>
        $(document).ready(function() {
            $('#block_install_baru').change(function() {
                ...
                $.get("{{ url('api/web/install-hari-ini-layanandesa') }}", params, function(data) {
                    ...
                    if (data.installHariIni.length > 0) {
                        ...
                        list_install_baru =
                            '<div class="text-wrap text-center">Tidak ada desa baru yang memasang LayananDesa hari ini</div>'
                    }
