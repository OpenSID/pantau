...
@section('title', 'Ubah Data Adat')

@section('content_header')
<h1>Adat<small class="font-weight-light ml-1 text-md">Ubah Data Adat</small></h1>
@stop
...
<div class="row">
    <div class="col-lg-6">
        ...
        <div class="card card-outline card-primary">
            ...
            <form method="POST" action="{{ route('adat.update', $adat->id) }}">
                <div class="card-body">
                    @method('PUT')
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-12">
                            <input class="form-control" value="{{ $adat->name }}" type="text" name="name" id="name"
                                placeholder="Nama Adat" required>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-12">
                            <select class="form-control" name="tbl_region_id" id="list_provinsi"
                                ...
                                <option value="{{ $adat->region->region_code }}" selected>
                                    {{ $adat->region->region_name }}</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
