    ...
    $(function() {
        ...
        function list_kabupaten() {
            ...
            $('#list_kabupaten').select2({
                ajax: {
                    url: host + 'list_wilayah?token=' + token + '&kode=' + $('#list_provinsi')
                        .val(),
                    dataType: 'json',
                    delay: 400,
                    data: function(params) {
        ...
        function list_kecamatan() {
            ...
            $('#list_kecamatan').select2({
                ajax: {
                    url: host + 'list_wilayah?token=' + token + '&kode=' + $('#list_kabupaten')
                        .val(),
                    dataType: 'json',
                    delay: 400,
                    data: function(params) {
