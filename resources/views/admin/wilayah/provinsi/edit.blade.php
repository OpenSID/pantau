...
@section('title', 'Ubah Data Provinsi')

@section('content_header')
<h1>Provinsi<small class="font-weight-light ml-1 text-md">Ubah Data Provinsi</small></h1>
@stop
                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            <input name="region_code" id="region_code" class="form-control" placeholder="00"
                                data-inputmask="{!! "'mask' :'99'" !!}" data-mask value="{{ $provinsi->kode_provinsi }}"
                                required readonly />
                        </div>
                        <div class="col-8">
                            <input name="region_name" id="region_name" class="form-control" placeholder="Nama Provinsi"
                                maxlength="80" value="{{ $provinsi->nama_provinsi_baru ?? $provinsi->nama_provinsi }}"
                                required />
                        </div>
                    </div>
                </div>
