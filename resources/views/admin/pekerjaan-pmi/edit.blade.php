...
@section('title', 'Edit Data Pekerjaan PMI')

@section('content_header')
<h1>Pekerjaan PMI<small class="font-weight-light ml-1 text-md">Edit Data Pekerjaan PMI</small></h1>
@stop
...
<div class="row">
    <div class="col-lg-6">
        ...
        <div class="card card-outline card-primary">
            ...
            <form method="POST" action="{{ route('pekerjaan-pmi.update', $pekerjaanPmi->id) }}">
                <div class="card-body">
                    @method('PUT')
                    @csrf
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-12">
                            <input class="form-control" value="{{ $pekerjaanPmi->nama }}" type="text" name="nama"
                                id="nama" placeholder="Nama Pekerjaan PMI" required>
                        </div>
                    </div>
                </div>
