...
@section('content_header')
    <h1>Profil Versi OpenSID<small class="font-weight-light ml-1 text-md font-weight-bold">(desa OpenSID) @if($provinsi = session('provinsi')) {{ "| {$provinsi->nama_prov}" }} @endif</small></h1>
@stop
